...
#below code is option, becoz i am running the code by terminal(command :  uv run mcp install main.py)
#if you are below code in main.py, then we can run (command : python main.py)
